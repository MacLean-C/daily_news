...
@st.cache_resource  
def load_model():
    return T5ForConditionalGeneration.from_pretrained(r"C:\Users\macle\Desktop\test\models\flan_t5")
...
@st.cache_resource  
def load_tokenizer():
    return T5Tokenizer.from_pretrained(r"C:\Users\macle\Desktop\test\models\flan_t5\tokenizer")
