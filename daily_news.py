...
if __name__ == "__main__":
    ...
    if language:
        ...
        if 'rss_url2' not in st.session_state:
                st.session_state['rss_url2'] = None
        ...
        if suggested: 
            ...
            st.session_state['rss_url2'] = rss_url2
        else: 
        ...
        if go:
            if st.session_state['rss_url2']:
                #url = st.session_state['rss_url2']
